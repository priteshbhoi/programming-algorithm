...
flowchart TD
    ...
    Graph --> G1[Traversals: BFS & DFS]
    G1 --> G2[Shortest Paths: Dijkstra, Bellman-Ford, Floyd-Warshall]
    G2 --> G3[Minimum Spanning Trees: Kruskal, Prim, Borůvka]
    G3 --> G4[Advanced: Network Flow, Matching, SCC]
```
